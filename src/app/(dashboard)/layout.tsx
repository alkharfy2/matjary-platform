...
const sidebarItems: DashboardSidebarItem[] = [
  ...
  { href: '/dashboard/abandoned-carts', label: 'السلات المتروكة', icon: 'abandoned-carts' },
  { href: '/dashboard/upsell', label: 'عروض Upsell', icon: 'upsell' },
  { href: '/dashboard/cross-sell', label: 'منتجات مرتبطة', icon: 'cross-sell' },
  ...
  { href: '/dashboard/blog', label: 'المدونة', icon: 'blog' },
  { href: '/dashboard/affiliates', label: 'الأفلييت', icon: 'affiliate' },
  { href: '/dashboard/loyalty', label: 'نقاط الولاء', icon: 'loyalty' },
  { href: '/dashboard/dropshipping', label: 'Dropshipping', icon: 'dropshipping' },
